...
def test_groups_source_qualified_sql_rows_into_stable_scenarios():
    rows = [
        {"scenario_id": "B", "shipment_id": "S-2", "lot_source_id": "FARM-A", "lot_code": "REC", "quantity_cases": 4},
        {"scenario_id": "A", "shipment_id": "S-1", "lot_source_id": "FARM-A", "lot_code": "REC", "quantity_cases": 4},
    ]
